...
public class DCTMAuthorizationProcess_1_1 implements AuthorizationProcessImpl {
	...
	public DCTMAuthorizationProcess_1_1() {
		...
		logger = Logger.getLogger(DCTMAuthorizationProcess_1_1.class);
	...
	public int authorize(HttpServletRequest request, HttpServletResponse response, Cookie[] authCookies, String url, String id) throws HttpException, IOException {
		...
		try {
			...
			if ((userAgent.startsWith("gsa-crawler") && userAgent.indexOf("(Enterprise") != -1)) {//crawl
				...
				TransformURL_1_1 tu = new TransformURL_1_1(webtopServletPath,authzServletPath);
